          ...
          renderItem={({item, index}) => (
            <TouchableOpacity
              ...
              {startGameState.length === 0 ? (
                ...
                <Image
                  source={startGameState[index] ? item.image : images.question}
...
export const appStyle = StyleSheet.create({
  ...
  iconImage: {
    width: windowWidth > 600 ? windowWidth * 0.15 : windowWidth * 0.2,
    height: windowWidth > 600 ? windowWidth * 0.15 : windowWidth * 0.2,
    resizeMode: 'contain',
  },
  startImage: {
