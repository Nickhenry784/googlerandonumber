  ...
  return (
    <ImageBackground style={appStyle.homeView} source={images.bg1}>
      ...
      <View style={appStyle.bottomView}>
        <Image
          source={bodyImg ? images.bogy2 : images.bogy1}
          style={[appStyle.btn, {position: 'absolute', bottom: '80%'}]}
        />
        <Animated.Image
          source={images.wind}
          style={[
        ...
        <TouchableOpacity onPress={() => setClick(true)}>
          <Image
            source={click ? images.human2 : images.human1}
            style={appStyle.btn}
          />
        </TouchableOpacity>
      </View>
...
export const appStyle = StyleSheet.create({
  ...
  textScore: {
    ...
    fontWeight: 'bold',
    color: 'black',
    marginBottom: windowWidth > 600 ? 200 : 100,
  },
  centerView: {
    width: windowWidth,
